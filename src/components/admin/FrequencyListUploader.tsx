...
export default function FrequencyListUploader() {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold text-gray-800 mb-4">
        Upload Icelandic Frequency List
      </h2>
      <p className="text-sm text-gray-600 mb-4">
        Upload a CSV file with Icelandic word frequencies. Expected format: word,frequency,rank
      </p>
      ...
      <div className="space-y-4">
        ...
        >
          {uploading ? 'Uploading...' : 'Upload Frequency List'}
        </button>
